...
consolo.log( a==b);
// En el operador && = Y, Deben de cumplirse ambas condiciones para que el resultado sea true o verdadero, si alguna de las condiciones no se cumple el resultado será false o falso.

//En este ejercicio, no se considera a quien no tenga 18 años.

let pais, edad;
pais = prompt("Ingresa tu país de procedencia:");
edad = prompt("Ingresa tu edad:");

if (pais === "Colombia" && edad >= 18) {
    document.writeln("Eres cuidadano del pais de colombia)")

}    else {
    document.writeln("No eres cuidadano del pais de colombia)")
}

// Solicita  el dia, el mes y el año, luego verifica si los valores ingresados son numericos.

let day, month, year;

day = parseInt(prompt("digite el día en numeros:"));
month = parseInt(prompt("digite el mes en numeros:"));
year = parseInt(prompt("digite el año en numeros:"));

//Validar si lso valores ingresados son numericos
